...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__DocRefer__3214EC2729E86C97");
            ...
            entity.HasOne(d => d.Doc).WithMany(p => p.DocReferances)
                ...
                .HasConstraintName("FK__DocRefera__DocID__2C3393D0");
        });

        modelBuilder.Entity<Document>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Document__3214EC2775186C9F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC27F642487E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ViewLog__3214EC272967FFC1");
